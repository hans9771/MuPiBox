<?php
	...
	if( $_POST['RTL88X2BU'] == "Install driver" )
		{
		$command = "cd; curl -L https://raw.githubusercontent.com/hans9771/MuPiBox/main/scripts/online/install_rtl88x2bu.sh | sudo su dietpi -c bash";
	...
	if( $_POST['RTL88X2BU'] == "Remove driver" )
		{
		$command = "cd; curl -L https://raw.githubusercontent.com/hans9771/MuPiBox/main/scripts/online/remove_rtl88x2bu.sh | sudo su dietpi -c bash";
		exec($command, $output, $result );
	...
	if( $_POST['change_samba'] == "enable & start" )
		{
		$command = "sudo apt-get install samba wsdd -y && sudo wget https://raw.githubusercontent.com/hans9771/MuPiBox/main/config/templates/smb.conf -O /etc/samba/smb.conf && sudo systemctl enable smbd.service && sudo systemctl start smbd.service";
		exec($command, $output, $result );
		$change=1;
	...
	if( $_POST['change_ftp'] == "enable & start" )
		{
		$command = " sudo apt-get install proftpd -y && sudo apt-get install samba -y && sudo wget https://raw.githubusercontent.com/hans9771/MuPiBox/main/config/templates/proftpd.conf -O /etc/proftpd/proftpd.conf && sudo systemctl restart proftpd";
		exec($command, $output, $result );
		$change=1;
