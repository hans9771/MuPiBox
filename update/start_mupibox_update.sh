...
#https://raw.githubusercontent.com/hans9771/MuPiBox/main
...
packages2install="git libasound2 jq mplayer pulseaudio-module-bluetooth pip id3tool bluez zip rrdtool scrot net-tools wireless-tools autoconf automake bc build-essential python3-gpiozero python3-rpi.gpio python3-lgpio python3-serial libgles2-mesa mesa-utils libsdl2-dev preload"
STEP=0
...
wget -O /tmp/installation.jpg https://raw.githubusercontent.com/hans9771/MuPiBox/main/media/images/installation.jpg >&3 2>&3
/usr/bin/fbv /tmp/installation.jpg & >&3 2>&3

wget -q -O ${VER_JSON} https://raw.githubusercontent.com/hans9771/MuPiBox/main/version.json  >&3 2>&3
