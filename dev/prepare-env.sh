...
# Start with: cd; curl https://raw.githubusercontent.com/hans9771/MuPiBox/main/development_prepare/prepare-env.sh | bash
...
wget https://github.com/hans9771/MuPiBox/raw/main/development_prepare/customize/mplayer-wrapper/index.js -O ~/.mupibox/mplayer-wrapper/index.js &>> ${LOG} 2>>${LOG}
...
wget https://raw.githubusercontent.com/hans9771/MuPiBox/main/config/templates/www.json -O ~/.mupibox/Sonos-Kids-Controller-master/server/config/config.json &>> ${LOG} 2>>${LOG}
wget https://github.com/hans9771/MuPiBox/raw/main/development_prepare/customize/Sonos-Kids-Controller-master/server.js -O ~/.mupibox/Sonos-Kids-Controller-master/server.js  &>> ${LOG} 2>>${LOG}
wget https://github.com/hans9771/MuPiBox/raw/main/development_prepare/customize/Sonos-Kids-Controller-master/angular.json -O ~/.mupibox/Sonos-Kids-Controller-master/angular.json &>> ${LOG} 2>>${LOG}
wget https://github.com/hans9771/MuPiBox/raw/main/development_prepare/customize/Sonos-Kids-Controller-master/src/app/player.service.ts -O ~/.mupibox/Sonos-Kids-Controller-master/src/app/player.service.ts &>> ${LOG} 2>>${LOG}
wget https://github.com/hans9771/MuPiBox/raw/main/development_prepare/customize/Sonos-Kids-Controller-master/src/app/player/player.page.html -O ~/.mupibox/Sonos-Kids-Controller-master/src/app/player/player.page.html &>> ${LOG} 2>>${LOG}
wget https://github.com/hans9771/MuPiBox/raw/main/development_prepare/customize/Sonos-Kids-Controller-master/src/app/player/player.page.scss -O ~/.mupibox/Sonos-Kids-Controller-master/src/app/player/player.page.scss &>> ${LOG} 2>>${LOG}
wget https://github.com/hans9771/MuPiBox/raw/main/development_prepare/customize/Sonos-Kids-Controller-master/src/app/player/player.page.ts -O ~/.mupibox/Sonos-Kids-Controller-master/src/app/player/player.page.ts &>> ${LOG} 2>>${LOG}
...
wget https://raw.githubusercontent.com/hans9771/MuPiBox/main/config/templates/spotifycontroller.json -O ~/.mupibox/spotifycontroller-main/config/config.json &>> ${LOG} 2>>${LOG}
wget https://github.com/hans9771/MuPiBox/raw/main/development_prepare/customize/spotiycontroller-main/spotify-control.js -O ~/.mupibox/spotifycontroller-main/spotify-control.js  &>> ${LOG} 2>>${LOG}
npm install  &>> ${LOG} 2>>${LOG}
npm start & &>> ${LOG} 2>>${LOG}
sleep 10  &>> ${LOG} 2>>${LOG}
...
# Binaries
sudo wget https://github.com/hans9771/MuPiBox/raw/main/bin/fbv/fbv -O /usr/bin/fbv  &>> ${LOG} 2>>${LOG}
sudo wget https://github.com/hans9771/MuPiBox/raw/main/bin/spotifyd/0.3.3/dietpi8_64bit/spotifyd -O /usr/bin/spotifyd  &>> ${LOG} 2>>${LOG}
...
# DietPi-Configs
#sudo wget https://raw.githubusercontent.com/hans9771/MuPiBox/main/config/templates/98-dietpi-disable_dpms.conf -O /etc/X11/xorg.conf.d/98-dietpi-disable_dpms.conf &>> ${LOG} 2>>${LOG}
sudo wget https://raw.githubusercontent.com/hans9771/MuPiBox/main/config/templates/asound.conf -O /etc/asound.conf &>> ${LOG} 2>>${LOG}
sudo wget https://raw.githubusercontent.com/hans9771/MuPiBox/main/config/templates/smb.conf -O /etc/samba/smb.conf &>> ${LOG} 2>>${LOG}
sleep 1
...
#wget https://raw.githubusercontent.com/hans9771/MuPiBox/main/config/templates/www.json -O ~/.mupibox/Sonos-Kids-Controller-master/server/config/config.json &>> ${LOG} 2>>${LOG}
#wget https://raw.githubusercontent.com/hans9771/MuPiBox/main/config/templates/spotifycontroller.json -O ~/.mupibox/spotifycontroller-main/config/config.json &>> ${LOG} 2>>${LOG}
sudo wget https://raw.githubusercontent.com/hans9771/MuPiBox/main/config/templates/spotifyd.conf -O /etc/spotifyd/spotifyd.conf &>> ${LOG} 2>>${LOG}
sleep 1
...
# Splash and Media
sudo wget https://raw.githubusercontent.com/hans9771/MuPiBox/main/config/templates/splash.txt -O /boot/splash.txt &>> ${LOG} 2>>${LOG}
sudo wget https://gitlab.com/DarkElvenAngel/initramfs-splash/-/raw/master/boot/initramfs.img -O /boot/initramfs.img &>> ${LOG} 2>>${LOG}
wget https://github.com/hans9771/MuPiBox/raw/main/media/images/goodbye.png -O ~/MuPiBox/sysmedia/images/goodbye.png &>> ${LOG} 2>>${LOG}
sudo wget https://github.com/hans9771/MuPiBox/raw/main/media/images/splash.png -O /boot/splash.png &>> ${LOG} 2>>${LOG}
wget https://github.com/hans9771/MuPiBox/raw/main/media/sound/shutdown.wav -O ~/MuPiBox/sysmedia/sound/shutdown.wav &>> ${LOG} 2>>${LOG}
wget https://github.com/hans9771/MuPiBox/raw/main/media/sound/startup.wav -O ~/MuPiBox/sysmedia/sound/startup.wav &>> ${LOG} 2>>${LOG}
sleep 1
...
# MuPiBox
sudo wget https://raw.githubusercontent.com/hans9771/MuPiBox/main/config/templates/mupiboxconfig.json -O /etc/mupibox/mupiboxconfig.json &>> ${LOG} 2>>${LOG}
sudo wget https://raw.githubusercontent.com/hans9771/MuPiBox/main/scripts/mupibox/change_checker.sh -O /usr/local/bin/mupibox/change_checker.sh &>> ${LOG} 2>>${LOG}
sudo wget https://raw.githubusercontent.com/hans9771/MuPiBox/main/scripts/mupibox/idle_shutdown.sh -O /usr/local/bin/mupibox/idle_shutdown.sh &>> ${LOG} 2>>${LOG}
sudo wget https://raw.githubusercontent.com/hans9771/MuPiBox/main/scripts/mupibox/m3u_generator.sh -O /usr/local/bin/mupibox/m3u_generator.sh &>> ${LOG} 2>>${LOG}
sudo wget https://raw.githubusercontent.com/hans9771/MuPiBox/main/scripts/mupibox/setting_update.sh -O /usr/local/bin/mupibox/setting_update.sh &>> ${LOG} 2>>${LOG}
sudo wget https://raw.githubusercontent.com/hans9771/MuPiBox/main/scripts/mupibox/software_shutdown.sh -O /usr/local/bin/mupibox/software_shutdown.sh &>> ${LOG} 2>>${LOG}
sudo wget https://raw.githubusercontent.com/hans9771/MuPiBox/main/scripts/mupibox/splash_screen.sh -O /usr/local/bin/mupibox/splash_screen.sh &>> ${LOG} 2>>${LOG}
...
sudo wget https://raw.githubusercontent.com/hans9771/MuPiBox/main/config/services/pulseaudio.service -O /etc/systemd/system/pulseaudio.service  &>> ${LOG} 2>>${LOG}
...
# OnOffShim & hifiberry
sudo wget https://raw.githubusercontent.com/hans9771/MuPiBox/main/scripts/OnOffShim/off_trigger.sh -O /var/lib/dietpi/postboot.d/off_trigger.sh &>> ${LOG} 2>>${LOG}
sudo wget https://raw.githubusercontent.com/hans9771/MuPiBox/main/scripts/OnOffShim/poweroff.sh -O /usr/lib/systemd/system-shutdown/poweroff.sh &>> ${LOG} 2>>${LOG}
...
sudo /boot/dietpi/dietpi-autostart 11 &>> ${LOG} 2>>${LOG}
sudo wget https://raw.githubusercontent.com/hans9771/MuPiBox/main/scripts/chromium-autostart.sh -O /var/lib/dietpi/dietpi-software/installed/chromium-autostart.sh &>> ${LOG} 2>>${LOG}
